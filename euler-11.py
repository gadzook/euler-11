...
for line in input:
	line = line.split()
	splitInput.append(line)

for line in enumerate(splitInput):
	row = line[0]
	for number in enumerate(line[1]):
		...
		if productDownRight != None: resultsList.append(productDownRight)
		if productDownLeft != None: resultsList.append(productDownLeft)

		#i'm certain there is a better & more beautiful way to do this but this will have to do
